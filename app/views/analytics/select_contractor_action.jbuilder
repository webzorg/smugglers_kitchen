...
json.contractor_code             @contractor.customer_name
json.contractor_state_id         @contractor.customer_code
json.contractor_physical_address @contractor.customer_tin
json.contractor_legal_address    @contractor.customer_actual_address
json.contractor_type             @contractor.customer_legal_address
json.contractor_name             @contractor.customer_type
